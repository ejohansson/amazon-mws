class Amazon::MWS::Authentication
  ...
  class QueryString < String
    def initialize(params = {})
      ...
      elsif params[:path].include? 'FulfillmentInventory'
      	query_params['SellerId'] = params[:merchant_id]
        query_params['Version'] = Amazon::MWS::Authentication::INVENTORY_VERSION
      else
      ...
      query_params['Signature'] = Signature.new(query_params, params) # Calculate the signature
